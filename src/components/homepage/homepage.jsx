...
import MajorNewsItem from './majornewsitem';
import TextNewsItem from './textnewsitem';
...
class HomePage extends React.Component {
  ...
  render() {
    const newsitems = newsItemData.map((d, i) => <Grid.Column key={`item-${i}`}> <NewsItem {...d}/> </Grid.Column>);
    ...
    return (
      <div>
        ...
        <Grid textAlign='center' columns={1} padded style={{position:'relative'}} celled>
          {newsitems[0]}
          <Grid.Column>
            <MajorNewsItem {...majorNewsItemData}/>
          </Grid.Column>
          {newsitems[1]}
          <Grid.Column>
            <TextNewsItem/>
